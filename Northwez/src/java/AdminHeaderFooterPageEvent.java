...
public class AdminHeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) 
    {
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase("page " + document.getPageNumber() + " of " + Methods.getPN()), 
                document.right() - 100, 30, 0);
        
        // There would always be an update of the timestamp on the bottom-left.
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase(Methods.getTS()), 
